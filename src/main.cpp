...
// configuration step. It creates a namespace called `BestPractices-gameJam`. You can modify
...
int main(int argc, const char **argv)
{
 ...
 Options:
    ...
    std::map<std::string, docopt::value> args = docopt::docopt(USAGE,
      ...
      fmt::format("{} {}",
        BestPractices-gameJam::cmake::project_name,
        BestPractices-gameJam::cmake::project_version));// version string, acquired
